...
})(
  {
    ...
    '50nS': [
      function(require, module, exports) {
        ...
        function n(n) {
          return n && 'object' == e(n) && 'default' in n ? n.default : n;
        }
        Object.defineProperty(exports, '__esModule', { value: !0 });
        var t = require('react'),
          r = n(t),
        ...
        var L = t.memo(function(e) {
            ...
            return t.createElement(
              ...
              t.createElement(
                ...
                t.createElement(I, null, e.title),
                t.createElement('img', {
                  onClick: r,
                  style: {
                    width: '16px',
              ...
              t.createElement(T, null, n)
            );
          }),
          I = u.h1(w()),
          T = u.div(E()),
          q = function() {
            var e = t.useState(1 / 0),
              n = e[0],
              r = e[1];
            return (
        ...
        var R = r.memo(function(e) {
            return r.createElement(
              ...
              r.createElement(O, { src: e.src, alt: e.title })
            );
          }),
          _ = u.div.attrs(function(e) {
            return {
              style: {
              ...
              t.createElement(
                ...
                'icon' in u
                  ? t.createElement(
                      ...
                      t.createElement(re, null, u.learned, '/', u.levels.length)
                    )
                  : t.createElement(
                      oe,
                      null,
                      'default' === a
                        ? t.createElement(ie, null, u.title)
                        : t.createElement(ue, { selected: i === y }, u.title)
                    )
              )
            );
          }),
        ...
        function ce(e) {
          var n = e.skill,
            ...
            g = m[0],
            v = m[1],
            b = t.useState(n.learned),
            k = b[0],
            x = b[1],
            E = t.useRef(null),
            w = t.useRef(0);
          function L() {
            var e = E.current.getBoundingClientRect(),
              n = e.left,
              t = window.scrollX;
            v((e.right - n) / 2 + n + t);
          }
          function I() {
            w.current = E.current.clientWidth;
          }
          function T() {
            L(), I();
          }
          t.useEffect(function() {
            var e = l.throttle(T, 200);
            return (
              L(),
              I(),
              window.addEventListener('resize', e),
            ...
            t.useEffect(
              function() {
                if (k === n.levels.length) return i(h), c(p, y, n), u(p, y, h);
              },
              [k]
            );
          var q = d.length > 1;
              ...
              t.createElement(
                ...
                t.createElement(J, {
                  handleClick: function() {
                    return r === S
                      ? null
                      : r === C && k < n.levels.length
                      ? (x(k + 1),
                        console.log(k),
                        console.log(n.levels.length - 1),
                        k < n.levels.length - 1
                          ? (c(p, C, n), u(p, C, h))
                          : void 0)
                      : void 0;
              ...
              t.createElement(
                ...
                d.map(function(e) {
                  return t.createElement(Je, {
                    ...
                    shouldBeUnlocked: r === y && o >= e.requiredLevel,
                    skill: e,
                  });
                })
              )
        ...
        var ve = require('styled-components').keyframes,
          be = require('styled-components').css;
        function ke(e) {
          var n = e.state;
          return r.createElement(
            xe,
        ...
        var Te = require('styled-components').keyframes,
          qe = require('styled-components').css;
        function Be(e) {
          var n = e.state;
        ...
        var _e = require('styled-components').keyframes,
          Oe = require('styled-components').css;
        function Me(e) {
          var n = e.direction,
            t = e.parentPosition,
            o = e.childPosition,
        ...
        var Ke = require('styled-components').keyframes,
        ...
        function Xe(e) {
          var n = e.state,
            o = e.childNodeRef,
            i = e.parentPosition;
          if (!e.parentHasMultipleChildren)
            return r.createElement(ke, { state: n });
          var u = t.useState(0),
            a = u[0],
            c = u[1],
            d = i < a ? 'right' : 'left';
          ...
          return (
            ...
            r.createElement(
              'div',
              { style: { height: '56px' } },
              r.createElement(Be, { state: n, direction: d }),
              r.createElement(
                'div',
                ...
                r.createElement(Ue, { direction: d, state: n })
              )
            )
          );
        }
                  ...
                  return r.setState(function(e) {
                    return {
                      skills: l.mapValues(e.skills, function(e) {
                        return { optional: e.optional, nodeState: S };
                      }),
        ...
        function Je(e) {
          var n = e.skill,
            ...
            v = t.useRef(null),
            b = f[n.id] ? f[n.id].nodeState : 'locked';
          return (
            t.useEffect(
              function() {
                if (!s) {
                  if (b === y && !a) return h(), p(n.id, S, n.optional);
                  if (b === C && !a) return p(n.id, S, n.optional);
                  if (a) return b === S && a ? p(n.id, C, n.optional) : void 0;
                }
              },
              [b, a, s]
            ),
            t.useEffect(
              function() {
                if (!s) return l.isEmpty(f) ? p(n.id, C) : void 0;
              },
              [s]
            ),
            r.createElement(
              ...
              r.createElement(
                ...
                { ref: v },
                r.createElement(de, {
                  incSkillCount: t.useCallback(m, []),
                  decSkillCount: t.useCallback(h, []),
                  updateSkillState: p,
                  currentLevel: c,
                  skill: n,
                  nodeState: b,
        ...
        (Ze.contextType = f),
          ...
          (Je.defaultProps = { hasParent: !0 });
        var tn = require('styled-components').css;
        function rn(e) {
          var n = e.isVisible,
            o = e.children,
            i = t.useState(n),
          ...
          return (
            ...
            u
              ? r.createElement(
                  on,
                  { 'data-testid': 'visibility-container', isVisible: n },
                  o
                )
              : null
          );
        }
        var on = u.div(nn(), function(e) {
          return !e.isVisible && tn(en());
        });
        function un(e) {
          var n = e.data,
            r = t.useContext(f).addToSkillCount,
            o = t.useContext(Ye).setSkillCount;
          return (
            t.useEffect(function() {
              var e = (function e(n) {
                return n.reduce(
        ...
        function an() {
          ...
          return r.createElement(cn, null, e.skillCount, ' skills');
        }
        var cn = u.p(ln(), function(e) {
        ...
        var vn = require('styled-components').css;
        function bn(e) {
          var n = e.handleClick,
            o = e.collapsible,
            u = e.isVisible,
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(
                'div',
                { style: { position: 'relative' } },
                r.createElement(xn, { isCollapsible: o, isVisible: u }, '▲'),
                r.createElement(Cn, { id: l }, a)
              ),
        ...
        (exports.SkillProvider = function(e) {
          return r.createElement(h, null, r.createElement(v, null, e.children));
        }),
          (exports.SkillTree = function(e) {
            ...
            return r.createElement(
              r.Fragment,
              null,
              r.createElement(yn, { treeId: a, skills: n }),
              r.createElement(En, {
                disabled: m,
                isVisible: b,
                setVisibility: k,
...
//# sourceMappingURL=/example.a133e55c.js.map
