...
React.forwardRef(function Node(props, ref) {
  ...
  return React.createElement(StyledNode, {
    ...
    src: skill.icon,
    containerWidth: 64
  }), React.createElement(LevelNode, null, learned, "/", skill.levels.length)) : React.createElement(TextNode, null, color === 'default' ? React.createElement(React.Fragment, null, React.createElement(Text, null, skill.title), React.createElement(TextLevelNode, null, learned, "/", skill.levels.length)) : React.createElement(React.Fragment, null, React.createElement(AlternativeText, {
    selected: currentState === SELECTED_STATE
  }, skill.title), React.createElement(TextLevelNode, null, learned, "/", skill.levels.length))));
});
var shadowburst =
/*#__PURE__*/
keyframes(
...
styled__default.div(
/*#__PURE__*/
_templateObject10(), function (_ref12) {
...
styled__default.p(
/*#__PURE__*/
_templateObject11(), function (_ref16) {
...
/*#__PURE__*/
_templateObject12(), function (_ref18) {
  var theme = _ref18.theme;
  return theme.nodeAlternativeFontColor;
}, function (props) {
  return props.selected && css(_templateObject13(), function (_ref19) {
...
function SkillNode(_ref) {
  var skill = _ref.skill,
    ...
    return null;
      ...
      handleNodeRemove = _ref$handleNodeRemove === void 0 ? function () {
    return null;
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(StyledSkillNode, null, React__default.createElement(Tooltip, {
    title: title,
    tooltip: tooltip
    ...
    skill: skill,
    ref: skillNodeRef
  }))), children.length > 0 && React__default.createElement(SkillTreeSegmentWrapper, null, children.map(function (child) {
...
_templateObject$c(), function (_ref) {
  ...
  return isDisabled && css$6(_templateObject2$9(), function (_ref2) {
    var theme = _ref2.theme;
    return theme.disabledTreeOpacity;
  });
}, function (_ref3) {
  var isCollapsible = _ref3.isCollapsible;
  return isCollapsible && css$6(_templateObject3$5(), function (_ref4) {
    var theme = _ref4.theme;
    return theme.treeBackgroundColor;
  }, function (_ref5) {
    var theme = _ref5.theme;
...
styled__default.div(
/*#__PURE__*/
_templateObject$d(), function (_ref2) {
  var theme = _ref2.theme;
