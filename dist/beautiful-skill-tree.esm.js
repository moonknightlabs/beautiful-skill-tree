...
forwardRef(function Node(props, ref) {
  ...
  return createElement(StyledNode, {
    ...
    src: skill.icon,
    containerWidth: 64
  }), createElement(LevelNode, null, learned, "/", skill.levels.length)) : createElement(TextNode, null, color === 'default' ? createElement(Fragment, null, createElement(Text, null, skill.title), createElement(TextLevelNode, null, learned, "/", skill.levels.length)) : createElement(Fragment, null, createElement(AlternativeText, {
    selected: currentState === SELECTED_STATE
  }, skill.title), createElement(TextLevelNode, null, learned, "/", skill.levels.length))));
});
var shadowburst =
/*#__PURE__*/
keyframes(
