...
function ae(e) {
  ...
  t.useEffect(function() {
    ...
    t.useEffect(
      function() {
        if (i === n.levels.length) return a(b), s(g, S, n, i), c(g, S, b);
      },
      [i]
    );
  var R = h.length > 1;
...
function Ze(e) {
  ...
  return (
    ...
    n.useEffect(
      function() {
        if (!s) {
          if (w === S && !a) return p(r.id, C, r.optional);
          if (w === x && !a) return p(r.id, C, r.optional);
          if (a)
            return w === C && a
              ? p(r.id, x, r.optional)
              : w === S && a && 0 === E
...
var pn = require('styled-components').css;
function hn(e) {
  var r = e.handleClick,
    i = e.collapsible,
    l = e.isVisible,
  ...
  return t.createElement(
    ...
    t.createElement(
      ...
      t.createElement(
        'div',
        { style: { position: 'relative' } },
        t.createElement(vn, { isCollapsible: i, isVisible: l }, '▲'),
        t.createElement(bn, { id: u }, a)
      )
    )
  );
}
...
(exports.SkillProvider = function(e) {
  ...
  (exports.SkillTree = function(e) {
    ...
    return t.createElement(
      t.Fragment,
      null,
      t.createElement(kn, { treeId: a, skills: r }),
      t.createElement(Cn, {
        disabled: b,
        isVisible: x,
        setVisibility: S,
