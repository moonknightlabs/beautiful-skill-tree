...
var X = require('styled-components').keyframes,
  ...
  Z = n.forwardRef(function(e, t) {
    ...
    var m = function(e) {
      e.preventDefault(),
        0 === e.button
          ? (console.log('Left Click'), r())
          : 2 === e.button && (console.log('Right Click'), o());
    };
    return n.createElement(
      ee,
      {
...
function ae(e) {
  ...
  function L() {
    y.current = E.current.clientWidth;
  }
  function I() {
    w(), L();
  }
  n.useEffect(function() {
    var e = u.throttle(I, 200);
    return (
      w(),
      L(),
      window.addEventListener('resize', e),
    ...
    n.useEffect(
      function() {
        if (i === t.levels.length) return a(g), s(m, S, t), c(m, S, g);
      },
      [i]
    );
  var T = f.length > 1;
        ...
        n.createElement(Z, {
          handleClick: function() {
            return r === C
              ...
              ? (l(i + 1),
                i < t.levels.length - 1 ? (s(m, x, t), c(m, x, g)) : void 0)
              : void 0;
          },
          handleRightClick: function() {
            return r === C
              ...
              : r === x && i > 0
              ? (l(i - 1),
                0 === i ? (s(m, C, t), c(m, C, g)) : (s(m, x, t), c(m, x, g)))
              : r === S
              ? (l(i - 1), s(m, x, t), c(m, x, g))
              : void 0;
          },
          id: m,
          currentState: r,
...
var Ne = require('styled-components').keyframes,
...
function Ze(e) {
  var r = e.skill,
    ...
    v = n.useRef(null),
    b = t.useState(r.learned),
    k = b[0],
    E = b[1],
    y = f[r.id] ? f[r.id].nodeState : 'locked';
  return (
    n.useEffect(
      function() {
        if (!s) {
          if (y === S && !a) return h(), p(r.id, C, r.optional);
          if (y === x && !a) return E(0), p(r.id, C, r.optional);
          if (a) return y === C && a ? p(r.id, x, r.optional) : void 0;
        }
      },
      [y, a, s]
    ),
