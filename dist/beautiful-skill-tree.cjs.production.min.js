...
var u = n(require('@material-ui/icons/CheckBox'));
function c() {
  return (c =
    Object.assign ||
    function(n) {
...
var p = e.createContext({
  ...
  h = { selectedSkillCount: { required: 0, optional: 0 } };
function f(n) {
  var t = n.children,
    o = e.useState(''),
    i = o[0],
    l = o[1],
    a = e.useState({ required: 0, optional: 0 }),
    u = a[0],
    c = a[1],
    d = e.useReducer(s, h),
    f = d[1];
...
function C(n) {
  var t = n.theme,
    ...
    i = e.useContext(p),
    l = i.skillCount,
    a = i.selectedSkillCount,
    u = i.resetSkills,
    d = e.useContext(m).handleFilter,
    s = e.useMemo(
      function() {
        return c({}, g, {}, t);
      },
...
var Q = e.memo(function(n) {
    ...
    return e.createElement(
      ...
      e.createElement(L, null, i, ' Skill'),
      e.createElement(B, null, t),
      l &&
        d &&
        o !== E &&
        e.createElement(
          M,
          null,
          e.createElement(D, { onClick: c }, '-1 Level'),
          e.createElement(D, { onClick: u }, '+1 Level')
        )
    );
  }),
  z = i.h1(
    ...
    function(n) {
      return n.theme.tooltipTitleFontSize;
    }
  ),
  L = i.div(R()),
  B = i.div(U()),
...
function Y(n) {
  var r = n.children,
    ...
    h = void 0 === p ? 'top' : p,
    f = i.content,
    g = e.useContext(o.ThemeContext).tooltipZIndex,
    m = e.useRef(null),
    A = k(),
    v = t.useMemo(
      function() {
...
var Z = t.memo(function(n) {
    var e = n.src,
      r = n.title,
      o = n.currentState;
    return t.createElement(
      q,
      { 'data-testid': 'icon-container', containerWidth: n.containerWidth },
      o === E &&
        t.createElement(O, {
          src:
...
var an = require('styled-components').keyframes,
  un = require('styled-components').css,
  cn = e.forwardRef(function(n, t) {
    var r = n.handleClick,
      o = n.handleRightClick,
      i = n.id,
      l = n.currentState,
      a = n.skill,
      c = n.learned,
      ...
      g(
        (function() {
          ...
          if (navigator.platform)
            for (; n.length; ) if (navigator.platform === n.pop()) return !0;
          return !1;
        })()
      );
    }, []);
    ...
    return e.createElement(
      ...
      'icon' in a
        ? e.createElement(
            ...
            null,
            a.availableInGame &&
              e.createElement(gn, null, e.createElement(u, null)),
            e.createElement(Z, {
              title: 'node-icon',
              src: a.icon,
              currentState: l,
            ...
            e.createElement(fn, null, c, '/', a.levels.length)
          )
        : e.createElement(
            An,
            null,
            e.createElement(
              ...
              null,
              'default' === p
                ? e.createElement(vn, null, a.title)
                : e.createElement(Cn, { selected: l === b }, a.title),
              e.createElement(mn, null, c, '/', a.levels.length)
            )
          )
    );
  }),
...
function xn(n) {
  var e = n.skill,
    ...
    i = n.learned,
    a = n.skillPoint,
    u = n.childrenLearnedState,
    c = n.isOwner,
    d = n.handleLearnedChange,
    s = n.updateSkillState,
    p = n.handleNodeSelect,
    h =
      void 0 === p
        ? function() {
            return null;
  ...
  function z() {
    K.current = R.current.clientWidth;
  }
  function L() {
    Q(), z();
  }
  function B() {
    return r === E
      ? null
      : 0 !== a && r === x && i < e.levels.length
      ? (d(i + 1),
        i < e.levels.length - 1
          ? (h(C, x, e, i + 1), s(C, x, i + 1, S))
          : i === e.levels.length - 1
          ? (h(C, b, e, i + 1), s(C, b, i + 1, S))
          : void 0)
      : void 0;
  }
  function M() {
    if (r === E) return d(0), null;
    if (i !== e.actualLearned) {
      if (r === x && i > 0)
        return (
          d(i - 1),
          0 === i
            ? (g(C, E, e, i - 1), s(C, E, i - 1, S))
            : (g(C, x, e, i - 1), s(C, x, i - 1, S))
        );
      if (r === b) {
        if (
          u &&
          ...
          return;
        return d(i - 1), g(C, x, e, i - 1), s(C, x, i - 1, S);
      }
    }
  }
  t.useEffect(function() {
    var n = l.throttle(L, 200);
    return (
      Q(),
      z(),
      window.addEventListener('resize', n),
    ...
    t.useEffect(
      function() {
        if (i === e.levels.length) return s(C, b, i, S);
      },
      [i]
    );
  var D = m.length > 1;
      ...
      t.createElement(
        ...
        m.map(function(n) {
          return t.createElement(pe, {
            ...
            shouldBeUnlocked: r === b && o >= n.requiredLevel,
            skill: n,
            skillPoint: a,
          });
        })
...
var Qn = require('styled-components').keyframes,
  zn = require('styled-components').css;
function Ln(n) {
  var e = n.state;
  return t.createElement(
    Bn,
...
var Zn = require('styled-components').keyframes,
  qn = require('styled-components').css;
function Gn(n) {
  var e = n.state;
...
var On = i(Yn)(
    ...
    function(n) {
      return n.selected && 'left' === n.direction && qn(Nn(), Hn);
    },
    function(n) {
      return n.selected && 'right' === n.direction && qn(Fn(), Hn);
    }
  ),
  Hn = Zn(yn());
function Pn() {
...
var Xn = require('styled-components').keyframes,
  Jn = require('styled-components').css;
function _n(n) {
  var e = n.direction,
    r = n.parentPosition,
    o = n.childPosition,
...
function ce(n) {
  var r = n.state,
    o = n.childNodeRef,
    i = n.parentPosition;
  if (!n.parentHasMultipleChildren) return t.createElement(Ln, { state: r });
  var a = e.useState(0),
    u = a[0],
    c = a[1],
    d = i < u ? 'right' : 'left';
  ...
  return (
    ...
    t.createElement(
      'div',
      { style: { height: '56px' } },
      t.createElement(Gn, { state: r, direction: d }),
      t.createElement(
        'div',
        ...
        t.createElement(le, { direction: d, state: r })
      )
    )
  );
}
    ...
    function o(e, t) {
      ...
      return (
        ...
        (r.decrementSelectedCount = function(n) {
          void 0 === n && (n = !1);
          var e = {
            type: n ? 'DESELECT_OPTIONAL_SKILL' : 'DESELECT_REQUIRED_SKILL',
          };
          r.setState(function(n) {
            return { selectedCount: n.selectedCount - 1 };
          }),
        ...
        (r.handleNodeSelect = function(n, e, t, o) {
        ...
        (r.handleNodeRemove = function(n, e, t, o) {
        ...
        (r.updateSkillState = function(n, e, t, o) {
          void 0 === o && (o = !1);
          var i = r.props,
            l = i.handleSave,
            a = i.treeId;
          return r.setState(function(i) {
            ...
            return l(r.storage, a, d), { skills: d };
          });
        }),
        (r.state = {
          skills: {},
...
function pe(n) {
  var r = n.skill,
    ...
    h = p.mounting,
    f = p.skills,
    g = p.updateSkillState,
    m = p.decrementSelectedCount,
    A = p.incrementSelectedCount,
    v = p.handleNodeSelect,
    C = p.handleNodeRemove,
    S = e.useRef(null),
    k = t.useState(r.learned),
    I = k[0],
    w = k[1],
    U = f[r.id] ? f[r.id].nodeState : 'locked',
    R = r.children.map(function(n) {
      return f[n.id];
    });
  return (
    e.useEffect(
    ...
    e.useEffect(
      function() {
        if (!h) {
          if (U === b && !u) return g(r.id, E, r.learned, r.optional);
          if (U === x && !u)
            return w(r.learned), g(r.id, E, r.learned, r.optional);
          if (u)
            return U === E && u
              ? g(r.id, x, r.learned, r.optional)
              : U === b && u && 0 === I
              ? g(r.id, x, r.learned, r.optional)
              : void 0;
        }
    ...
    e.useEffect(
      function() {
        if (!h) return l.isEmpty(f) ? g(r.id, x, r.learned) : void 0;
      },
      [h]
    ),
    t.createElement(
      ...
      t.createElement(
        ...
        { ref: S },
        t.createElement(bn, {
          incSkillCount: e.useCallback(A, []),
          decSkillCount: e.useCallback(m, []),
          updateSkillState: g,
          currentLevel: c,
          skill: r,
          learned: I,
          skillPoint: d,
          isOwner: s,
          handleLearnedChange: function(n) {
            w(n);
          },
          nodeState: U,
          childrenLearnedState: R,
          handleNodeSelect: v,
          handleNodeRemove: C,
        })
      )
...
(se.contextType = p),
  ...
  (pe.defaultProps = { hasParent: !0 });
var me = require('styled-components').css;
function Ae(n) {
  var r = n.isVisible,
    o = n.children,
    i = e.useState(r),
...
var ve = i.div(ge(), function(n) {
  return !n.isVisible && me(fe());
});
function Ce(n) {
  var t = n.data,
    r = e.useContext(p).addToSkillCount,
    o = e.useContext(de).setSkillCount;
  return (
    e.useEffect(function() {
      var n = (function n(e) {
        return e.reduce(
          function(e, t) {
            ...
            if (t.children.length > 0) {
              var i = 'optional' === o ? 1 : 0,
                ...
                a = n(t.children);
              return {
                optional: e.optional + a.optional + i,
                required: e.required + a.required + l,
              };
            }
...
var Ue = require('styled-components').css;
function Re(n) {
  var r = n.handleClick,
    i = n.collapsible,
    l = n.isVisible,
    ...
    c = n.description,
    d = n.disabled,
    s = e.useContext(o.ThemeContext).tooltipZIndex,
    p = e.useCallback(
      function(n) {
        13 === n.keyCode && r();
      },
  ...
  return t.createElement(
    ...
    t.createElement(
      ...
      t.createElement(
        'div',
        { style: { position: 'relative' } },
        t.createElement(Qe, { isCollapsible: i, isVisible: l }, '▲'),
        t.createElement(Le, { id: a }, u)
      )
    )
  );
}
var Ke = i.div(
  ...
  Le = i.h2(Se(), function(n) {
    return n.theme.headingFont;
  });
function Be(n) {
  var t = n.skills,
    r = n.treeId,
    o = e.useContext(m).addToSkillMap;
  return (
    e.useEffect(function() {
      var n = (function(n, e) {
        var t = {};
...
function Me(n) {
  var t = n.setVisibility,
    r = n.isVisible,
    o = n.treeId,
    i = n.disabled,
    l = e.useContext(m).filtersMatches,
    a = e.useState(!1),
    u = a[0],
    c = a[1];
  return (
...
(exports.SkillProvider = function(n) {
  return t.createElement(f, null, t.createElement(A, null, n.children));
}),
  (exports.SkillTree = function(n) {
    ...
    return t.createElement(
      t.Fragment,
      null,
      t.createElement(Be, { treeId: u, skills: r }),
      t.createElement(Me, {
        disabled: v,
        isVisible: E,
        setVisibility: x,
      ...
      t.createElement(
        se,
        {
          ...
          savedData: c,
          handleSave: p,
          sendNodeSelectDataToClient: h,
          sendNodeRemoveDataToClient: f,
        },
        t.createElement(Ce, { data: r }),
        t.createElement(
          Ye,
          null,
          t.createElement(Re, {
          ...
          t.createElement(
            ...
            t.createElement(
              ...
              { isCollapsible: m },
              r.map(function(n, e) {
                var o = r.length - 1 !== e && C;
                return t.createElement(
                  t.Fragment,
                  { key: n.id },
                  t.createElement(pe, {
                    shouldBeUnlocked: a >= n.requiredLevel,
                    currentLevel: a,
                    skill: n,
                    hasParent: !1,
                    parentPosition: 0,
