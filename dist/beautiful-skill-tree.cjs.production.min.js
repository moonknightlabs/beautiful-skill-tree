    ...
    return n.createElement(
      ...
      'icon' in u
        ? n.createElement(
            ...
            n.createElement(te, null, a, '/', u.levels.length)
          )
        : n.createElement(
            re,
            null,
            'default' === d
              ...
              : n.createElement(ie, { selected: l === S }, u.title)
          )
    );
  }),
  J = X(G()),
...
function ae(e) {
  ...
  n.useEffect(function() {
    ...
    n.useEffect(
      function() {
        if (i === t.levels.length) return a(b), s(g, S, t, i), c(g, S, b);
      },
      [i]
    );
  var R = h.length > 1;
...
var ve = require('styled-components').keyframes,
  ge = require('styled-components').css;
function be(e) {
  var n = e.state;
  return t.createElement(
    ke,
...
var Fe = require('styled-components').keyframes,
  ...
  return (
    ...
    t.createElement(
      ...
      t.createElement(
        ...
        t.createElement(Ue, { direction: d, state: r })
      )
    )
  );
}
          ...
          return r.setState(function(e) {
            return {
              skills: l.mapValues(e.skills, function(e) {
                return { optional: e.optional, nodeState: C };
              }),
  ...
  return (
    ...
    n.useEffect(
      function() {
        if (!s) {
          if (w === S && !a)
            return console.log('Selected state'), h(), p(r.id, C, r.optional);
          if (w === x && !a)
            return y(0), console.log('Unlocked State'), p(r.id, C, r.optional);
          if (a)
            return w === C && a
              ? (console.log('LOcked state'), p(r.id, x, r.optional))
              : void 0;
        }
      },
      [w, a, s, r.learned]
    ...
    n.useEffect(
      function() {
        if (!s) return l.isEmpty(f) ? p(r.id, x) : void 0;
      },
      [s]
    ),
    t.createElement(
  ...
  return t.createElement(
    ...
    t.createElement(
      ...
      t.createElement(
        'div',
        { style: { position: 'relative' } },
        t.createElement(kn, { isCollapsible: i, isVisible: l }, '▲'),
        t.createElement(xn, { id: u }, a)
      ),
      t.createElement(un, null)
    )
  );
}
var bn = i.div(
