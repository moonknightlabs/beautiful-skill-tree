...
var M = g.memo(function(A) {
    ...
    return g.createElement(
      ...
      g.createElement(L, null, e, ' Skill'),
      g.createElement(S, null, B),
      Q &&
        r &&
        n !== l &&
        g.createElement(
          F,
          null,
          g.createElement(x, { onClick: t }, '-1 Level'),
          g.createElement(x, { onClick: I }, '+1 Level')
        )
    );
  }),
  j = e.h1(
...
var GA = require('styled-components').keyframes,
  yA = require('styled-components').css;
function pA(A) {
  var g = A.state;
...
function Eg(A) {
  var C = A.state,
    n = A.childNodeRef,
    e = A.parentPosition;
  if (!A.parentHasMultipleChildren) return B.createElement(jA, { state: C });
  var E = g.useState(0),
    I = E[0],
    t = E[1],
    r = e < I ? 'right' : 'left';
  ...
  return (
    ...
    B.createElement(
      'div',
      { style: { height: '56px' } },
      B.createElement(pA, { state: C, direction: r }),
      B.createElement(
        'div',
...
(exports.SkillProvider = function(A) {
  ...
  (exports.SkillTree = function(A) {
    ...
    return B.createElement(
      B.Fragment,
      null,
      B.createElement(jg, { treeId: I, skills: C }),
      B.createElement(Lg, {
        disabled: D,
        isVisible: l,
        setVisibility: s,
