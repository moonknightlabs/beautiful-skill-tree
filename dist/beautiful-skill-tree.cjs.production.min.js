    ...
    return n.createElement(
      ...
      'icon' in l
        ? n.createElement(
            ...
            n.createElement(te, null, a, '/', l.levels.length)
          )
        : n.createElement(
            re,
            null,
            'default' === d
              ? n.createElement(oe, null, l.title)
              : n.createElement(ie, { selected: u === S }, l.title)
          )
    );
  }),
  J = X(G()),
...
function Ze(e) {
  ...
  return (
    ...
    n.useEffect(
      function() {
        if (!s) {
          ...
          if (a) return w === C && a ? p(r.id, x, r.optional) : void 0;
        }
      },
      [w, a, s]
    ),
    n.useEffect(
      function() {
        if (!s) return u.isEmpty(f) ? p(r.id, x) : void 0;
      },
      [s]
    ),
    t.createElement(
