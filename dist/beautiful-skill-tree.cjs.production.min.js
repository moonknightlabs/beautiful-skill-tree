...
function D(e) {
  ...
  function k() {
    if (v.current) return v.current.hide();
  }
  var x = t.useMemo(
    function() {
...
function ve(e) {
  ...
  function P() {
    q.current = R.current.clientWidth;
  }
  function B() {
    N(), P();
  }
    ...
    if (i !== n.actualLearned) {
      if (r === S && i > 0)
        return (
          d(i - 1),
          0 === i
            ? (v(y, x, n, i - 1), f(y, x, i - 1, E))
            : (v(y, S, n, i - 1), f(y, S, i - 1, E))
        );
      if (r === C) {
        if (
          a &&
          ...
          return;
        return d(i - 1), v(y, S, n, i - 1), f(y, S, i - 1, E);
      }
    }
  }
  t.useEffect(function() {
    var e = l.throttle(B, 200);
    return (
      N(),
      P(),
      window.addEventListener('resize', e),
    ...
    t.useEffect(
      function() {
        if (i === n.levels.length) return s(E), h(y, C, n, i), f(y, C, i, E);
      },
      [i]
    );
  var z = g.length > 1;
...
function ln(e) {
  var r = e.skill,
    ...
    v = f.decrementSelectedCount,
    g = f.incrementSelectedCount,
    ...
    w = E[0],
    L = E[1],
    I = h[r.id] ? h[r.id].nodeState : 'locked',
    T = r.children.map(function(e) {
      return h[e.id];
    });
  return (
    n.useEffect(
    ...
    n.useEffect(
      function() {
        if (!p) {
          if (I === C && !a) return m(r.id, x, r.learned, r.optional);
          if (I === S && !a)
            return L(r.learned), m(r.id, x, r.learned, r.optional);
          if (a)
            return I === x && a
              ? m(r.id, S, r.learned, r.optional)
              : I === C && a && 0 === w
              ? m(r.id, S, r.learned, r.optional)
              : void 0;
        }
    ...
    n.useEffect(
      function() {
        if (!p) return l.isEmpty(h) ? m(r.id, S, r.learned) : void 0;
      },
      [p]
    ),
    t.createElement(
      ...
      t.createElement(
        ...
        { ref: y },
        t.createElement(ge, {
          incSkillCount: n.useCallback(g, []),
          decSkillCount: n.useCallback(v, []),
          updateSkillState: m,
          currentLevel: c,
          skill: r,
          learned: w,
