...
function ae(e) {
  ...
  function q() {
    I.current = L.current.clientWidth;
  }
  function R() {
    T(), q();
  }
  n.useEffect(
    ...
    n.useEffect(
      function() {
        if (y === t.levels.length) return i(v), c(m, S, t, y), u(m, S, v);
      },
      [y]
    );
  var B = f.length > 1;
