...
var g = require('react'),
  ...
  e = A(n),
  Q = require('lodash'),
  E = A(require('@tippy.js/react'));
require('tippy.js/dist/tippy.css'),
  require('tippy.js/animations/shift-away.css');
var I = A(require('@material-ui/icons/CheckBox'));
function t() {
  return (t =
    Object.assign ||
    function(A) {
...
function r(A, g) {
  return g || (g = A.slice(0)), (A.raw = g), A;
}
function f(A, g) {
  switch (g.type) {
    case 'SELECT_REQUIRED_SKILL':
      return t({}, A, {
        selectedSkillCount: {
          optional: A.selectedSkillCount.optional,
          required: A.selectedSkillCount.required + 1,
        },
      });
    ...
    case 'SELECT_OPTIONAL_SKILL':
      return t({}, A, {
        selectedSkillCount: {
          optional: A.selectedSkillCount.optional + 1,
          required: A.selectedSkillCount.required,
        },
      });
...
var w = g.createContext({
  ...
  c = { selectedSkillCount: { required: 0, optional: 0 } };
function o(A) {
  var B = A.children,
    n = g.useState(''),
    e = n[0],
    Q = n[1],
    E = g.useState({ required: 0, optional: 0 }),
    I = E[0],
    t = E[1],
    r = g.useReducer(f, c),
    o = r[1];
  return g.createElement(
    w.Provider,
    {
      value: {
        skillCount: I,
        dispatch: o,
        addToSkillCount: function(A) {
          return t(function(g) {
            return {
              required: g.required + A.required,
              optional: g.optional + A.optional,
            };
          });
        },
        selectedSkillCount: r[0].selectedSkillCount,
        resetId: e,
        resetSkills: function() {
          o({ type: 'RESET_SKILLS' }), Q(C.v4());
        },
      },
    },
    B
    ...
    u.Provider,
    {
      value: {
        ...
        handleFilter: function(A) {
          if ('' === A.trim()) return Q(null);
          var g = A.toLowerCase(),
            B = Object.keys(C).filter(function(A) {
              return A.includes(g);
            }),
            n = new Set(
              B.map(function(A) {
...
function i(A) {
  var B = A.theme,
    ...
    e = g.useContext(w),
    Q = e.skillCount,
    E = e.selectedSkillCount,
    I = e.resetSkills,
    r = g.useContext(u).handleFilter,
    f = g.useMemo(
      function() {
        return t({}, v, {}, B);
      },
...
i.defaultProps = { theme: v };
var P = e.div(
    D(),
    function(A) {
      return A.theme.primaryFont;
    },
    function(A) {
      return A.theme.primaryFontColor;
    }
  ),
  l = 'locked',
  s = 'unlocked',
  H = 'selected',
  z = function() {
    var A = g.useState(Infinity),
      B = A[0],
      C = A[1];
    return (
      g.useEffect(function() {
        C(window.innerWidth);
        var A = Q.throttle(function() {
          C(window.innerWidth);
        }, 500);
        return (
...
var M = g.memo(function(A) {
    ...
    return g.createElement(
      ...
      g.createElement(j, null, e, ' Skill'),
      g.createElement(F, null, B),
      Q &&
        r &&
        n !== l &&
        g.createElement(
          S,
          null,
          g.createElement(J, { onClick: t }, '-1 Level'),
          g.createElement(J, { onClick: I }, '+1 Level')
        )
    );
  }),
  L = e.h1(
    h(),
    function(A) {
      return A.theme.headingFont;
    },
    function(A) {
      return A.theme.tooltipTitleFontSize;
    }
  ),
  j = e.div(a()),
  F = e.div(b()),
...
function x(A) {
  var C = A.children,
    ...
    c = void 0 === w ? 'top' : w,
    o = e.content,
    v = g.useContext(n.ThemeContext).tooltipZIndex,
    u = g.useRef(null),
    d = z(),
    D = B.useMemo(
      function() {
  ...
  function i() {
    if (u.current) return u.current.hide();
  }
  var P = B.useMemo(
    function() {
...
var k = e(E)(
  R(),
  function(A) {
    return A.theme.treeBackgroundColor;
  },
  function(A) {
    return A.theme.border;
  },
  function(A) {
    return A.theme.nodeHoverBorderColor;
  },
  function(A) {
    return A.theme.borderRadius;
  },
  function(A) {
    return A.theme.treeBackgroundColor;
  }
...
var V = B.memo(function(A) {
    var g = A.src,
      C = A.title,
      n = A.currentState;
    return B.createElement(
      p,
      { 'data-testid': 'icon-container', containerWidth: A.containerWidth },
      n === l &&
        B.createElement(Y, {
          src:
      ...
      B.createElement(q, { src: g, alt: C, locked: n === l })
    );
  }),
  p = e.div.attrs(function(A) {
    return {
      style: {
        height: A.containerWidth + 'px',
        width: A.containerWidth + 'px',
      },
    };
  })(G()),
  q = e.img(y(), function(A) {
    return A.locked && '\n    opacity: 0.2;\n  ';
  }),
  Y = e.img(K());
function T() {
...
var QA = require('styled-components').keyframes,
  EA = require('styled-components').css,
  IA = g.forwardRef(function(A, B) {
    var C = A.handleClick,
      n = A.handleRightClick,
      e = A.id,
      Q = A.currentState,
      E = A.skill,
      t = A.learned,
    ...
    return g.createElement(
      ...
      'icon' in E
        ? g.createElement(
            ...
            null,
            E.availableInGame &&
              g.createElement(oA, null, g.createElement(I, null)),
            g.createElement(V, {
              title: 'node-icon',
              src: E.icon,
              currentState: Q,
            ...
            g.createElement(cA, null, t, '/', E.levels.length)
          )
        : g.createElement(
            uA,
            null,
            g.createElement(
              ...
              null,
              'default' === w
                ? g.createElement(dA, null, E.title)
                : g.createElement(DA, { selected: Q === H }, E.title),
              g.createElement(vA, null, t, '/', E.levels.length)
            )
          )
    );
  }),
  ...
  fA = e.div(
    CA(),
    function(A) {
      return A.theme.nodeBackgroundColor;
    },
    function(A) {
      return A.theme.nodeBorderColor;
    },
    function(A) {
      return A.theme.borderRadius;
    },
    function(A) {
      return (
        ...
        EA(BA(), tA, function(g) {
          var B = g.theme;
          return 'default' === A.color
            ? B.nodeActiveBackgroundColor
            : B.nodeAlternativeActiveBackgroundColor;
        })
      );
    },
    function(A) {
      return (
        ...
        EA(
          ...
          function(A) {
            return A.theme.nodeHoverBorder;
          },
          function(A) {
            return A.theme.nodeHoverBorder;
          },
  ...
  wA = e.div($(), function(A) {
    return A.theme.nodeIconNodeWidth;
  }),
  cA = e.div(_()),
  oA = e.div(Z()),
  vA = e.div(W()),
  uA = e.div(
    m(),
    function(A) {
      return A.theme.nodeMobileTextNodeHeight;
    },
    function(A) {
      return A.theme.nodeMobileTextNodeWidth;
    },
    function(A) {
      return A.theme.nodeDesktopTextNodeHeight;
    },
    function(A) {
      return A.theme.nodeDesktopTextNodeWidth;
    }
  ),
  dA = e.p(
    U(),
    function(A) {
      return A.theme.nodeMobileFontSize;
    },
    function(A) {
      return A.theme.nodeDesktopFontSize;
    }
  ),
  DA = e(dA)(
    N(),
    function(A) {
      return A.theme.nodeAlternativeFontColor;
    },
    function(A) {
      return (
        A.selected &&
        EA(T(), function(A) {
          return A.theme.nodeAltenativeActiveFontColor;
        })
      );
    }
  );
...
function lA(A) {
  var g = A.skill,
    ...
    e = A.learned,
    E = A.skillPoint,
    I = A.childrenLearnedState,
    t = A.isOwner,
    r = A.handleLearnedChange,
    f = A.updateSkillState,
    w = A.handleNodeSelect,
    c =
      void 0 === w
        ? function() {
            return null;
    ...
    h = B.useRef(0);
  function M() {
    var A = a.current.getBoundingClientRect(),
      g = A.left,
      B = window.scrollX;
    b((A.right - g) / 2 + g + B);
  }
  function L() {
    h.current = a.current.clientWidth;
  }
  function j() {
    M(), L();
  }
  function F() {
    return C === l
      ? null
      : 0 !== E && C === s && e < g.levels.length
      ? (r(e + 1),
        e < g.levels.length - 1
          ? (c(i, s, g, e + 1), f(i, s, e + 1, P))
          : void 0)
      : void 0;
  }
  function S() {
    if (C === l) return r(0), null;
    if (e !== g.actualLearned) {
      if (C === s && e > 0)
        return (
          r(e - 1),
          0 === e
            ? (v(i, l, g, e - 1), f(i, l, e - 1, P))
            : (v(i, s, g, e - 1), f(i, s, e - 1, P))
        );
      if (C === H) {
        if (
          I &&
          ...
          return;
        return r(e - 1), v(i, s, g, e - 1), f(i, s, e - 1, P);
      }
    }
  }
  B.useEffect(function() {
    var A = Q.throttle(j, 200);
    return (
      M(),
      L(),
      window.addEventListener('resize', A),
    ...
    B.useEffect(
      function() {
        if (e === g.levels.length)
          return console.log('TESTING'), c(i, H, g, e), f(i, H, e, P);
      },
      [e]
    );
  var J = u.length > 1;
  return B.createElement(
    ...
    u.length > 0 &&
      B.createElement(
        ...
        null,
        u.map(function(A) {
          return B.createElement(rg, {
            key: A.id,
            hasParent: !0,
            currentLevel: n,
            parentPosition: X,
            isOwner: t,
            parentHasMultipleChildren: J,
            shouldBeUnlocked: C === H && n >= A.requiredLevel,
            skill: A,
            skillPoint: E,
          });
        })
...
var hA = require('styled-components').keyframes,
  MA = require('styled-components').css;
function LA(A) {
  var g = A.state;
  return B.createElement(
    jA,
...
var jA = e.div(aA()),
  ...
  SA = e.div(
    XA(),
    function(A) {
      return A.theme.edgeBorder;
    },
    function(A) {
      return A.selected && MA(OA(), FA);
    },
    function(A) {
      return A.unlocked && '\n      opacity: 1;\n    ';
    }
...
var yA = require('styled-components').keyframes,
  GA = require('styled-components').css;
function VA(A) {
  var g = A.state;
...
var UA = require('styled-components').keyframes,
  mA = require('styled-components').css;
function WA(A) {
  var g = A.direction,
    C = A.parentPosition,
    n = A.childPosition,
    e = A.state;
  return B.createElement(ZA, {
    'data-testid': 'middle-angled-line',
    direction: g,
    unlocked: e !== l,
    selected: e === H,
    width: 'left' === g ? C - n - 6 + 5 : n - C - 6 + 5,
  });
}
var ZA = e(RA)(
    NA(),
...
var Bg = require('styled-components').keyframes,
  Cg = require('styled-components').css;
function ng(A) {
  var g = A.state;
  return B.createElement(eg, {
    unlocked: g !== l,
    direction: A.direction,
...
function Eg(A) {
  var C = A.state,
    n = A.childNodeRef,
    e = A.parentPosition;
  if (!A.parentHasMultipleChildren) return B.createElement(LA, { state: C });
  var E = g.useState(0),
    I = E[0],
    t = E[1],
    r = e < I ? 'right' : 'left';
  function f() {
    var A = n.current.getBoundingClientRect(),
      g = window.scrollX;
    t(A.left + A.width / 2 + g);
  }
  return (
    g.useEffect(function() {
      var A = Q.throttle(f, 200);
      return (
        window.addEventListener('resize', A),
        f(),
        function() {
    ...
    B.createElement(
      'div',
      { style: { height: '56px' } },
      B.createElement(VA, { state: C, direction: r }),
      B.createElement(
        'div',
        ...
        B.createElement(ng, { direction: r, state: C })
      )
    )
  );
}
var Ig = g.createContext({
    mounting: !0,
    skills: {},
    skillCount: 0,
    selectedCount: 0,
  ...
  tg = (function(A) {
    ...
    function n(g, B) {
      var C;
      return (
        ((C = A.call(this, g, B) || this).storage = null),
        (C.getTreeSkills = function() {
          if (C.props.savedData) return C.props.savedData;
          var A = C.storage.getItem('skills-' + C.props.treeId);
          return 'undefined' === A || null === A ? {} : JSON.parse(A);
        }),
        (C.incrementSelectedCount = function(A) {
          void 0 === A && (A = !1);
          var g = {
            type: A ? 'SELECT_OPTIONAL_SKILL' : 'SELECT_REQUIRED_SKILL',
          };
          C.setState(function(A) {
            return { selectedCount: A.selectedCount + 1 };
          }),
            C.context.dispatch(g);
        }),
        (C.decrementSelectedCount = function(A) {
          void 0 === A && (A = !1);
          var g = {
            type: A ? 'DESELECT_OPTIONAL_SKILL' : 'DESELECT_REQUIRED_SKILL',
          };
          C.setState(function(A) {
            return { selectedCount: A.selectedCount - 1 };
          }),
        ...
        (C.resetSkills = function() {
          return C.setState(function(A) {
            return {
              skills: Q.mapValues(A.skills, function(A) {
                return {
                  optional: A.optional,
                  nodeState: l,
                  learned: A.learned,
              ...
              resetId: C.context.resetId,
            };
          });
        }),
        (C.setSkillCount = function(A) {
          return C.setState({ skillCount: A });
        }),
        (C.handleNodeSelect = function(A, g, B, n) {
          return C.props.sendNodeSelectDataToClient({
            key: A,
            state: g,
            skill: B,
            learned: n,
        ...
        (C.handleNodeRemove = function(A, g, B, n) {
          return C.props.sendNodeRemoveDataToClient({
            key: A,
            state: g,
            skill: B,
            learned: n,
        ...
        (C.updateSkillState = function(A, g, B, n) {
          void 0 === n && (n = !1);
          var e = C.props,
            Q = e.handleSave,
            E = e.treeId;
          return C.setState(function(e) {
            var I,
              r = t(
                {},
                e.skills,
            ...
            return Q(C.storage, E, r), { skills: r };
          });
        }),
        (C.state = {
          skills: {},
    ...
    return (
      (e.componentDidMount = function() {
        ...
        return (
          ...
          this.setState({ skills: g, selectedCount: B, mounting: !1 }),
          null
        );
      }),
...
function rg(A) {
  var C = A.skill,
    n = A.hasParent,
    e = A.parentHasMultipleChildren,
    E = A.parentPosition,
    I = A.shouldBeUnlocked,
    t = A.currentLevel,
    r = A.skillPoint,
    f = A.isOwner,
    w = g.useContext(Ig),
    c = w.mounting,
    o = w.skills,
    v = w.updateSkillState,
    u = w.decrementSelectedCount,
    d = w.incrementSelectedCount,
    D = w.handleNodeSelect,
    i = w.handleNodeRemove,
    P = g.useRef(null),
    z = B.useState(C.learned),
    O = z[0],
    X = z[1],
    b = o[C.id] ? o[C.id].nodeState : 'locked',
    a = C.children.map(function(A) {
      return o[A.id];
    });
  return (
    g.useEffect(
    ...
    g.useEffect(
      function() {
        if (!c) {
          if (b === H && !I) return v(C.id, l, C.learned, C.optional);
          if (b === s && !I)
            return X(C.learned), v(C.id, l, C.learned, C.optional);
          if (I)
            return b === l && I
              ? v(C.id, s, C.learned, C.optional)
              : b === H && I && 0 === O
              ? v(C.id, s, C.learned, C.optional)
              : void 0;
        }
    ...
    g.useEffect(
      function() {
        if (!c) return Q.isEmpty(o) ? v(C.id, s, C.learned) : void 0;
      },
      [c]
    ),
    B.createElement(
      'div',
      { style: { margin: n ? '' : '16px 0' } },
      n &&
        B.createElement(Eg, {
          parentHasMultipleChildren: e,
          state: b,
          childNodeRef: P,
          parentPosition: E,
        }),
      B.createElement(
        ...
        { ref: P },
        B.createElement(sA, {
          incSkillCount: g.useCallback(d, []),
          decSkillCount: g.useCallback(u, []),
          updateSkillState: v,
          currentLevel: t,
          skill: C,
          learned: O,
          skillPoint: r,
          isOwner: f,
          handleLearnedChange: function(A) {
            X(A);
          },
          nodeState: b,
          childrenLearnedState: a,
          handleNodeSelect: D,
          handleNodeRemove: i,
        })
      )
...
(tg.contextType = w),
  (tg.defaultProps = {
    handleSave: function(A, g, B) {
      return A.setItem('skills-' + g, JSON.stringify(B));
    },
  ...
  (rg.defaultProps = { hasParent: !0 });
var og = require('styled-components').css;
function vg(A) {
  var C = A.isVisible,
    n = A.children,
    e = g.useState(C),
  ...
  return (
    ...
    Q
      ? B.createElement(
          ug,
          { 'data-testid': 'visibility-container', isVisible: C },
          n
        )
      : null
  );
}
var ug = e.div(cg(), function(A) {
  return !A.isVisible && og(wg());
});
function dg(A) {
  var B = A.data,
    C = g.useContext(w).addToSkillCount,
    n = g.useContext(Ig).setSkillCount;
  return (
    g.useEffect(function() {
      var A = (function A(g) {
        return g.reduce(
          function(g, B) {
            var C,
              n = B.optional ? 'optional' : 'required';
            if (B.children.length > 0) {
              var e = 'optional' === n ? 1 : 0,
                Q = 'required' === n ? 1 : 0,
                E = A(B.children);
              return {
                optional: g.optional + E.optional + e,
                required: g.required + E.required + Q,
              };
            }
            return t({}, g, (((C = {})[n] = g[n] + 1), C));
          },
          { required: 0, optional: 0 }
        );
      })(B);
      n(A.required + A.optional), C(A);
    }, []),
    null
  );
}
...
function Xg(A) {
  var C = A.handleClick,
    ...
    t = A.description,
    r = A.disabled,
    f = g.useContext(n.ThemeContext).tooltipZIndex,
    w = g.useCallback(
      function(A) {
        13 === A.keyCode && C();
      },
  ...
  return B.createElement(
    hg,
    { zIndex: f, enabled: Boolean(t), content: t || '' },
    B.createElement(
      bg,
      {
        tabIndex: 0,
      ...
      B.createElement(
        'div',
        { style: { position: 'relative' } },
        B.createElement(ag, { isCollapsible: e, isVisible: Q }, '▲'),
        B.createElement(Mg, { id: E }, I)
      )
    )
  );
}
var bg = e.div(
    ...
    function(A) {
      return (
        A.isDisabled &&
        Og(Hg(), function(A) {
          return A.theme.disabledTreeOpacity;
        })
      );
    },
    function(A) {
      return (
        ...
        Og(
          ...
          function(A) {
            return A.theme.headingHoverColorTransition;
          },
          function(A) {
            return A.theme.headingHoverColor;
          }
        )
      );
    }
  ...
  ag = e.span(
    lg(),
    function(A) {
      return A.theme.headingFontColor;
    },
    function(A) {
      return A.isCollapsible ? 'inline' : 'none';
    },
    function(A) {
      return A.theme.headingFont;
    },
    function(A) {
      return A.theme.headingFontSize;
    },
    function(A) {
      return A.isVisible && Og(Pg());
    }
  ),
  hg = e(E)(
    ig(),
    function(A) {
      return A.theme.tooltipBackgroundColor;
    },
    function(A) {
      return A.theme.tooltipFontColor;
    },
    function(A) {
      return A.theme.tooltipBackgroundColor;
    }
  ),
  Mg = e.h2(Dg(), function(A) {
    return A.theme.headingFont;
  });
function Lg(A) {
  var B = A.skills,
    C = A.treeId,
    n = g.useContext(u).addToSkillMap;
  return (
    g.useEffect(function() {
      var A = (function(A, g) {
        var B = {};
        return (
          (function g(C) {
            C.forEach(function(C) {
              C.children.length > 0 && g(C.children),
                (B[C.title.toLowerCase()] = A);
            });
          })(g),
          B
        );
...
function jg(A) {
  var B = A.setVisibility,
    C = A.isVisible,
    n = A.treeId,
    e = A.disabled,
    Q = g.useContext(u).filtersMatches,
    E = g.useState(!1),
    I = E[0],
    t = E[1];
  return (
...
var Jg = e.div(Sg(), function(A) {
  ...
  Rg = e.div(
    ...
    function(A) {
      return A.isCollapsible ? '0' : 'auto';
    },
    function(A) {
      return A.theme.borderRadius;
    }
  );
(exports.SkillProvider = function(A) {
  return B.createElement(o, null, B.createElement(d, null, A.children));
}),
  (exports.SkillTree = function(A) {
    var C = A.data,
      n = A.title,
      e = A.description,
      Q = A.closedByDefault,
    ...
    return B.createElement(
      B.Fragment,
      null,
      B.createElement(Lg, { treeId: I, skills: C }),
      B.createElement(jg, {
        disabled: D,
        isVisible: l,
        setVisibility: s,
      ...
      B.createElement(
        tg,
        {
          ...
          savedData: t,
          handleSave: w,
          sendNodeSelectDataToClient: c,
          sendNodeRemoveDataToClient: o,
        },
        B.createElement(dg, { data: C }),
        B.createElement(
          Jg,
          null,
          B.createElement(Xg, {
          ...
          B.createElement(
            ...
            B.createElement(
              ...
              { isCollapsible: u },
              C.map(function(A, g) {
                var n = C.length - 1 !== g && i;
                return B.createElement(
                  B.Fragment,
                  { key: A.id },
                  B.createElement(rg, {
                    shouldBeUnlocked: E >= A.requiredLevel,
                    currentLevel: E,
                    skill: A,
                    hasParent: !1,
                    parentPosition: 0,
