...
var f = g.createContext({
  ...
  w = { selectedSkillCount: { required: 0, optional: 0 } };
function c(A) {
  var B = A.children,
    n = g.useState(''),
    e = n[0],
  ...
  return g.createElement(
    f.Provider,
    {
      value: {
        ...
        selectedSkillCount: c[0].selectedSkillCount,
        resetId: e,
        resetSkills: function() {
    ...
    return g.createElement(
      ...
      Q &&
        ...
        g.createElement(
          F,
          null,
          g.createElement(S, { onClick: t }, '-1 Level'),
          g.createElement(S, { onClick: I }, '+1 Level')
        )
    );
  }),
  M = e.h1(
...
var G = B.memo(function(A) {
    ...
    return B.createElement(
      ...
      B.createElement(p, { src: g, alt: C, locked: n === P })
    );
  }),
...
var nA = require('styled-components').keyframes,
  eA = require('styled-components').css,
  QA = g.forwardRef(function(A, B) {
    var C = A.handleClick,
    ...
    return g.createElement(
      ...
      'icon' in E
        ? g.createElement(
            ...
            g.createElement(fA, null, I, '/', E.levels.length)
          )
        : g.createElement(
            cA,
            null,
            g.createElement(
              ...
              null,
              'default' === f
                ? g.createElement(oA, null, E.title)
                : g.createElement(vA, { selected: Q === s }, E.title),
              g.createElement(wA, null, I, '/', E.levels.length)
            )
          )
    );
  }),
...
function DA(A) {
  ...
  function S() {
    return C === P
      ? null
      : 0 !== E && C === l && e < g.levels.length
      ? (r(e + 1),
        e < g.levels.length - 1
          ? (o(H, l, g, e + 1), w(H, l, e + 1, O))
          : void 0)
      : void 0;
  }
  function J() {
    if (C === P) return r(0), null;
    if (e !== g.actualLearned) {
      if (C === l && e > 0)
        return (
          r(e - 1),
          0 === e
            ? (u(H, P, g, e - 1), w(H, P, e - 1, O))
            : (u(H, l, g, e - 1), w(H, l, e - 1, O))
        );
      if (C === s) {
        if (
          I &&
          ...
          return;
        return r(e - 1), u(H, l, g, e - 1), w(H, l, e - 1, O);
      }
    }
  }
  B.useEffect(function() {
    ...
    B.useEffect(
      function() {
        if (e === g.levels.length) return f(O), o(H, s, g, e), w(H, s, e, O);
      },
      [e]
    );
  var x = d.length > 1;
      ...
      B.createElement(
        ...
        d.map(function(A) {
          return B.createElement(Eg, {
            ...
            shouldBeUnlocked: C === s && n >= A.requiredLevel,
            skill: A,
            skillPoint: E,
          });
        })
...
var XA = require('styled-components').keyframes,
  bA = require('styled-components').css;
function aA(A) {
  var g = A.state;
  return B.createElement(
    hA,
...
var xA = require('styled-components').keyframes,
  kA = require('styled-components').css;
function KA(A) {
  var g = A.state;
...
var YA = require('styled-components').keyframes,
  TA = require('styled-components').css;
function NA(A) {
  var g = A.direction,
    C = A.parentPosition,
    n = A.childPosition,
    e = A.state;
  return B.createElement(UA, {
...
var $A = require('styled-components').keyframes,
  Ag = require('styled-components').css;
function gg(A) {
  var g = A.state;
  return B.createElement(Bg, {
    unlocked: g !== P,
    direction: A.direction,
...
function ng(A) {
  var C = A.state,
    n = A.childNodeRef,
    e = A.parentPosition;
  if (!A.parentHasMultipleChildren) return B.createElement(aA, { state: C });
  var E = g.useState(0),
    I = E[0],
    t = E[1],
    r = e < I ? 'right' : 'left';
  ...
  return (
    ...
    B.createElement(
      'div',
      { style: { height: '56px' } },
      B.createElement(KA, { state: C, direction: r }),
      B.createElement(
        'div',
        ...
        B.createElement(gg, { direction: r, state: C })
      )
    )
  );
}
var eg = g.createContext({
    mounting: !0,
    skills: {},
    skillCount: 0,
    selectedCount: 0,
...
function Eg(A) {
  ...
  return (
    ...
    g.useEffect(
      function() {
        if (!c) {
          if (b === s && !I) return v(C.id, P, C.learned, C.optional);
          if (b === l && !I)
            return X(C.learned), v(C.id, P, C.learned, C.optional);
          if (I)
            return b === P && I
              ? v(C.id, l, C.learned, C.optional)
              : b === s && I && 0 === z
              ? v(C.id, l, C.learned, C.optional)
              : void 0;
        }
    ...
    g.useEffect(
      function() {
        if (!c) return Q.isEmpty(o) ? v(C.id, l, C.learned) : void 0;
      },
      [c]
    ),
    B.createElement(
...
(Qg.contextType = f),
  ...
  (Eg.defaultProps = { hasParent: !0 });
var fg = require('styled-components').css;
function wg(A) {
  var C = A.isVisible,
    n = A.children,
    e = g.useState(C),
...
var cg = e.div(rg(), function(A) {
  return !A.isVisible && fg(tg());
});
function og(A) {
  var B = A.data,
    C = g.useContext(f).addToSkillCount,
    n = g.useContext(eg).setSkillCount;
  return (
    g.useEffect(function() {
      var A = (function A(g) {
        return g.reduce(
...
var sg = require('styled-components').css;
function Hg(A) {
  var C = A.handleClick,
    e = A.collapsible,
    Q = A.isVisible,
  ...
  return B.createElement(
    ...
    B.createElement(
      ...
      B.createElement(
        'div',
        { style: { position: 'relative' } },
        B.createElement(zg, { isCollapsible: e, isVisible: Q }, '▲'),
        B.createElement(bg, { id: E }, I)
      )
    )
  );
}
var Og = e.div(
  ...
  bg = e.h2(vg(), function(A) {
    return A.theme.headingFont;
  });
function ag(A) {
  var B = A.skills,
    C = A.treeId,
    n = g.useContext(v).addToSkillMap;
  return (
    g.useEffect(function() {
      var A = (function(A, g) {
        var B = {};
...
function hg(A) {
  var B = A.setVisibility,
    ...
    n = A.treeId,
    e = A.disabled,
    Q = g.useContext(v).filtersMatches,
    E = g.useState(!1),
    I = E[0],
    t = E[1];
  return (
...
(exports.SkillProvider = function(A) {
  return B.createElement(c, null, B.createElement(u, null, A.children));
}),
  (exports.SkillTree = function(A) {
    ...
    return B.createElement(
      B.Fragment,
      null,
      B.createElement(ag, { treeId: I, skills: C }),
      B.createElement(hg, {
        disabled: D,
        isVisible: l,
        setVisibility: s,
