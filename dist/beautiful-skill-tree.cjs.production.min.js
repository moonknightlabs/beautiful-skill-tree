...
function lA(A) {
  var g = A.skill,
    ...
    M = B.useRef(0);
  function L() {
    var A = h.current.getBoundingClientRect(),
      g = A.left,
      B = window.scrollX;
    a((A.right - g) / 2 + g + B);
  }
  function j() {
    M.current = h.current.clientWidth;
  }
  function F() {
    L(), j();
  }
    ...
    if (e !== g.actualLearned) {
      if (C === s && e > 0)
        return (
          r(e - 1),
          0 === e
            ? (u(P, l, g, e - 1), w(P, l, e - 1, z))
            : (u(P, s, g, e - 1), w(P, s, e - 1, z))
        );
      if (C === H) {
        if (
          I &&
          ...
          return;
        return r(e - 1), u(P, s, g, e - 1), w(P, s, e - 1, z);
      }
    }
  }
  B.useEffect(function() {
    ...
    B.useEffect(
      function() {
        if (e === g.levels.length) return f(z), o(P, H, g, e), w(P, H, e, z);
      },
      [e]
    );
  var R = d.length > 1;
